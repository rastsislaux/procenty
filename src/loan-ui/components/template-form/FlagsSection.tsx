    ...
    <SectionContainer>
      <div className="flex flex-col gap-3 sm:gap-4">
        <div className="flex items-center justify-between">
          <div className="font-medium flex-1 text-sm sm:text-base">{t.templates.allowFirstPayment}</div>
        ...
        <div className="flex items-center justify-between">
          <div className="font-medium flex-1 text-sm sm:text-base">{t.templates.allowPrepayments}</div>
